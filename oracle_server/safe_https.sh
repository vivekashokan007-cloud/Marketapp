...
nohup sudo ~/oracle_server/venv/bin/uvicorn evaluator_app:app --host 0.0.0.0 --port 443 --ssl-keyfile /etc/letsencrypt/live/marketradar-oracle.online/privkey.pem --ssl-certfile /etc/letsencrypt/live/marketradar-oracle.online/fullchain.pem > uvicorn.log 2>&1 &
